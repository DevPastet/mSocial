...
if ($object->xpdo) {
    ...
    switch ($options[xPDOTransport::PACKAGE_ACTION]) {
        ...
        case xPDOTransport::ACTION_UPGRADE:
            $modelPath = $modx->getOption('msocial_core_path', null, $modx->getOption('core_path') . 'components/msocial/') . 'model/';
            $modx->addPackage('msocial', $modelPath);

            $manager = $modx->getManager();
            $objects = array();
            $schemaFile = MODX_CORE_PATH . 'components/msocial/model/schema/msocial.mysql.schema.xml';
